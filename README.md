...
**v0.96 beta** — Thimbleweed Park을 한국어로 즐길 수 있게 해주는 팬 번역
...
### v0.96 beta (2026-08-31)

- "레트로 폰트" 옵션 켰을 때 한글 일부 획이 사라지던 문제 수정
  (`FontRetroSheet`의 한글 2,350자 전체가 정상 폰트보다 6px 짧은 칸에
  구워져 있어서 ㅗ/ㅜ가 들어간 글자의 아래쪽 획이 잘려나갔던 것 —
  예: 누구→느그, 본→븐, 술→슬).
